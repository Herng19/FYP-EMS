    ...
    <div class="my-4 px-8">
        <form action="/rubric/edit/{{ $rubric->rubric_id }}" method="POST">
                        ...
                        <div class="flex grid grid-cols-3 gap-4 mt-2">
                            <div>
                                <select id="research-group" name="research_group" class="block text-sm font-semibold mt-1 w-full bg-white border border-slate-200 text-gray-700 focus:ring-primary-400 focus:border-0 px-4 py-2 rounded-md" required>
                                    <option value="" class="text-gray-400 font-semibold" default>--Reseach Group--</option>
                            ...
                            <div>
                                <select id="evaluation-number" name="evaluation_number" class="block text-sm font-semibold mt-1 w-full bg-white border border-slate-200 text-gray-700 focus:ring-primary-400 focus:border-0 px-4 py-2 rounded-md" required>
                                    ...
                                    <option value="evaluation1" class="text-gray-500 font-semibold" {{ ($rubric->evaluation_type == "evaluation1")? "selected" : "" }}>Evaluation 1 (by supervisor)</option>
                                    <option value="evaluation2" class="text-gray-500 font-semibold" {{ ($rubric->evaluation_type == "evaluation2")? "selected" : "" }}>Evaluation 2 (by evaluators)</option>
                                    <option value="evaluation3" class="text-gray-500 font-semibold" {{ ($rubric->evaluation_type == "evaluation3")? "selected" : "" }}>Evaluation 3 (by supervisor)</option>
                                </select>
                            </div>
                            <div>
                                <select id="PSM" name="PSM" class="block text-sm font-semibold mt-1 w-full bg-white border border-slate-200 text-gray-700 focus:ring-primary-400 focus:border-0 px-4 py-2 rounded-md" required>
                                    ...
                                    <option value="1" class="text-gray-500 font-semibold" {{ ($rubric->psm_year == "1")? "selected" : "" }}>PSM 1</option>
                                    <option value="2" class="text-gray-500 font-semibold" {{ ($rubric->psm_year == "2")? "selected": "" }}>PSM 2</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="px-8 mt-2" id="criteria-0-0">
                            <div class="flex">
                                <div class="grid grid-cols-5 gap-2 w-full">
                                    ...
                                    <div>
                                        <select id="sub-criteria-co-level" name="criteria[{{ $i }}][{{ $j }}][sub_criteria_co_level]" class="block text-sm font-semibold mt-1 w-full bg-white border border-slate-200 text-gray-700 focus:ring-primary-400 focus:border-0 px-4 py-2 rounded-md" required>
                                            <option value="" class="text-gray-400 font-semibold" default>--CO Level--</option>
                                            <option value="co-1" class="text-gray-500 font-semibold" {{ ($sub_criteria->co_level == "co-1")? "selected" : "" }}>CO 1</option>
                                            <option value="co-2" class="text-gray-500 font-semibold" {{ ($sub_criteria->co_level == "co-2")? "selected" : "" }}>CO 2</option>
                                            <option value="co-3" class="text-gray-500 font-semibold" {{ ($sub_criteria->co_level == "co-3")? "selected" : "" }}>CO 3</option>
                                        </select>
                                    </div>
                                </div>
            ...
            <div class="flex justify-end mt-8 mx-8">
                <a href="/rubric"><x-secondary-button class="mr-2">Back</x-secondary-button></a>
