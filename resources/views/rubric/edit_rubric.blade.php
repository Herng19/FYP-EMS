                        ...
                        <div class="px-4 mt-2" id="criteria-0-0">
                            ...
                            <div class="pl-6">
                                ...
                                <div class="flex items-center mt-2">
                                    ...
                                    <x-input id="scale-2" class="block text-sm mt-1 w-full pl-4 bg-white" type="text" name="criteria[{{ $i }}][{{ $j }}][scale_2]" value="<in between>" readonly="readonly"/>
                                </div>
                                <div class="flex items-center mt-2">
                                ...
                                <div class="flex items-center mt-2">
                                    ...
                                    <x-input id="scale-4" class="block text-sm mt-1 w-full pl-4 bg-white " type="text" name="criteria[{{ $i }}][{{ $j }}][scale_4]" value="<in between>" readonly="readonly"/>
                                </div>
                                <div class="flex items-center mt-2">
