                ...
                @foreach ($industrial_evaluators as $i => $industrial_evaluator)
                    <tr class="flex px-8 py-2 items-center {{ ($i%2 == 0)? 'bg-primary-50' : '';}}">
                        ...
                        <td class="flex py-2 items-center justify-center w-1/3">
                            <a href="/industrial evaluator/edit/{{ $industrial_evaluator->industrial_evaluator_id }}" class="rounded-full py-2 px-3 bg-green-100 border border-green-200 justify-center items-center hover:bg-green-200">
