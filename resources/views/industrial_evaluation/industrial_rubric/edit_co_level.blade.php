<x-app-layout>
    ...
    <div class="mt-2 mb-4 mx-12 bg-white rounded-md py-6 px-8">
        ...
        <div class="mt-2 mx-4">
            <form action="/industrial rubric/edit-co-level/{{ $co_level->industrial_co_level_id }}" method="POST">
                @method('PUT')
                @csrf
                ...
                <div class="flex justify-end items-center mt-4">
                    <a href="/industrial rubric/co-level-settings"><x-secondary-button class="mr-2">back</x-secondary-button></a>
